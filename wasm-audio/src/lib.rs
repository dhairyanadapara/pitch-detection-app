...
#[wasm_bindgen]     //Macro to help implement binding between JS and rust
pub struct WasmPitchDetector {
    sample_rate: usize,
    fft_size: usize,
    detector: mcleod::McLeodDetector<f32>,
}
...
impl WasmPitchDetector {
    pub fn new(sample_rate: usize, fft_size: usize) -> WasmPitchDetector {
        ...
        WasmPitchDetector {
            sample_rate,
            fft_size,
            detector: mcleod::McLeodDetector::<f32>::new(fft_size, fft_pad),
        }
    }
